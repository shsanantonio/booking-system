                  ...
                  <div
                    ...
                    <div className="flex flex-col">
                      ...
                      <span className="text-sm text-gray-500 leading-5">
                        Your booking for The Beverly Hills Hotel, CA has been confirmed!{" "}
                      </span>
                ...
                {({ active }) => (
                  <div
                    ...
                    <div className="flex flex-col">
                      ...
                      <span className="text-sm text-gray-500 leading-5">
                        Your crest card has been charged $97. The charge will appear as “Chekins.com book”{" "}
                      </span>
                ...
                {({ active }) => (
                  <div
                    ...
                    <div className="flex flex-col">
                      ...
                      <span className="text-sm text-gray-500 leading-5">
                        Your booking for The Beverly Hills Hotel is coming up on May 25, 2024, at 6 p.m.{" "}
                      </span>
